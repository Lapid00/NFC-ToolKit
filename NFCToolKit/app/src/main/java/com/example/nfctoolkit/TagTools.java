    ...
    public String getMessage(Intent intent) {
        ...
        public void checkNFCState(){
            ...
            if (adapter != null && adapter.isEnabled()) {
                ...
                Snackbar.make(view, context.getResources().getString(R.string.nfcOnPrompt), Snackbar.LENGTH_SHORT)
                        .show();
            }else if(adapter != null && !adapter.isEnabled()){
                Snackbar.make(view, context.getResources().getString(R.string.nfcOffPrompt), Snackbar.LENGTH_SHORT)
                        .show();
            }else{
                Snackbar.make(view, context.getResources().getString(R.string.nfcNonePrompt), Snackbar.LENGTH_SHORT)
                        .show();
            }
        }
